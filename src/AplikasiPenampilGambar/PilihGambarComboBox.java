...
public class PilihGambarComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ronaldo.jpg"))); // NOI18N
        pCardLayout.add(jLabel3, "2");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/haaland.jpg"))); // NOI18N
        pCardLayout.add(jLabel4, "3");

        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -", "Mbappe", "C.Ronaldo", "Haaland" }));
